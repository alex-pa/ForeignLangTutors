...
namespace ForeignLangTutorsMVC.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public RoomsController(ForeignLangTutorsDBContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Number,Capacity,Description")] Rooms rooms)
        {
            if (id != rooms.Id)
            {
                return NotFound();
