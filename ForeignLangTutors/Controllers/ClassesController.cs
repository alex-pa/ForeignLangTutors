...
namespace ForeignLangTutorsMVC.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ClassesController(ForeignLangTutorsDBContext context)
        {
            _context = context;
        }
        ...
        {
            var foreignLangTutorsDBContext = _context.Classes.Include(c => c.Group).Include(c => c.Room);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Topic,GroupId,RoomId,BeginningTime,СompletionTime")] Classes classes)
        {
            if (id != classes.Id)
            {
                return NotFound();
            ...
            ViewData["GroupId"] = new SelectList(_context.Groups, "Id", "Language", classes.GroupId);
            ViewData["RoomId"] = new SelectList(_context.Rooms, "Id", "Number", classes.RoomId);
            return View(classes);
        }
